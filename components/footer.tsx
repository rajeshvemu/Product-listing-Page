    ...
    <footer className="bg-gray-100 mt-12">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/categories/clothing" className="text-gray-600 hover:text-blue-600">
                  Clothing
                </Link>
              </li>
              <li>
                <Link href="/categories/jewelry" className="text-gray-600 hover:text-blue-600">
                  Jewelry
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600">© 2023 ShopNow. All rights reserved.</p>
